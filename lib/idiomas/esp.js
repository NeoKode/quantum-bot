...
RpgH: (n = "", k = "") => [`Con cuánto de poción desea recuperar su salud, ejemplo de uso:\n\n${n} 1`, "No tiene suficiente poción para usar!", `Acaba de usar ${n} de poción, salud aumentada a ${k}`],
...
RpgT: (m = "", d = "", z = "") => [`Formato incorrecto, use un dato válido:\n\nLista de tipos que puede usar:\n- nivel\n- experiencia\n- horda\n- elementos\n- planetas\n- gays\n\n_Ejemplo de uso:_\n${Prefijo+m} nivel\n`,`*🌟 Ranking ${m}:*\n\n${d} ${z>0?`\n\n_📍Tu posición es: ${z}_`:""}`],
