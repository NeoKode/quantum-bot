...
Anws:(n="",e="",k="",o="")=>[`*[ ! ] No se encontraron noticias recientes para ese tema.*`,`📰 *ÚLTIMA NOTICIA ÙwÚ!* 📰\n\n📌 *Título:* ${n}\n🕒 *Publicado:* ${e}\n🏷️ *Categorías:* ${k}\n\n🔗 *Leer completo:* ${o}`,"*[ ✓ ] Noticias anime detenido para este chat.*","*[ ✓ ] Noticias anime activado. Recibirás una noticia aleatoria del día cada 3 horas en este chat.*","*[ ! ] Por favor ingresa un día válido (1-31).*",`*[ ! ] No encontré noticias para el día ${n}${e}.*`],
