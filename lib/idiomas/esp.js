...
RpgE: (n='', e='', k='', o='', m='', d='', z='') => [`*[ ! ] Ya realizaste una exploración recientemente, por favor espera*\n🕐 ${n}...*\n`, `🪨 ${n ? '*No encontraste recursos por ahora u.u*' : '*Has descubierto:* '}\n${e ? `\n🛢️ Gas: ${e}` : ''} ${k ? `\n⚒️  Wolframio: ${k}` : ''} ${o ? `\n⚒️  Oro: ${o}` : ''} ${m ? `\n⚒️  Hierro: ${m}` : ''} ${d ? `\n⚒️  Aluminio: ${d}` : ''} ${z ? `\n⚒️  Silicio: ${z}` : ''}\n`, "🗑️ *No se encontró nada por ahora*\n\n", `*🏳️ Has encontrado una nueva civilización:* ${n}!, alianzas realizadas ${e}, ahora tu horda esta conformado por ${k} unidades.`, "🏴 Hasta el momento, no se ha registrado ningún avistamiento de vida alienígena en este planeta."],
