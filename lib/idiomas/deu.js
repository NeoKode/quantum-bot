...
Anws:(n="",e="",k="",o="")=>[`*[ ! ] Keine aktuellen Nachrichten zu diesem Thema gefunden.*`,`📰 *LETZTE NACHRICHT ÙwÚ!* 📰\n\n📌 *Titel:* ${n}\n🕒 *Veröffentlicht:* ${e}\n🏷️ *Kategorien:* ${k}\n\n🔗 *Vollständig lesen:* ${o}`,"*[ ✓ ] Anime-Nachrichten für diesen Chat gestoppt.*","*[ ✓ ] Anime-News aktiviert. Du erhältst täglich eine zufällige Neuigkeit.*","*[ ! ] Bitte gib einen gültigen Tag ein (1-31).*",`*[ ! ] Ich habe keine Nachrichten für den Tag ${n}${e} gefunden.*`],
