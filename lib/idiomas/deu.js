...
GpOpt: (n = '', k = "") => [`${n ? 'Aktiviert' : 'Deaktiviert'} ${k} für diese Gruppe`, "Hier ist die Liste der Optionen :3", "Option", "Beschreibung:", "Befehl:"],

GpActn: () => [{
titulo: "[ ⬇️ AUTOMATISCHE BEGRÜSSUNG ]",
func: [{
action: "[ 🛬 Aktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ʷᶦʳᵈ ⁿᵉᵘᵉ ᵀᵉᶦˡⁿᵉʰᵐᵉʳ ᶦⁿ ᵉᶦⁿᵉʳ ᴳʳᵘᵖᵖᵉ ʰᵉʳᶻᵘᵐ ʷᶦˡˡᵏᵒᵐᵐᵉⁿ~",
cmd: `${Prefijo}encender bienvenida`
}, {
action: "[ 🛫 Deaktivieren ]",
desc: "~ᴱˢ ʷᶦʳᵈ ᵏᵉᶦⁿᵉ ᴮᵉᵍʳᵘ̈ßᵘⁿᵍ ᶠᵘ̈ʳ ⁿᵉᵘᵉ ᵀᵉᶦˡⁿᵉʰᵐᵉʳ ᶦⁿ ᵉᶦⁿᵉʳ ᴳʳᵘᵖᵖᵉ ᵍᵉᵍᵉᵇᵉⁿ~",
cmd: `${Prefijo}apagar bienvenida`
}]
}, {
titulo: "[ ⬇️ AUTOMATISCHER ABSCHIED ]",
func: [{
action: "[ 👋 Aktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ʷᶦʳᵈ ᵈᵃˢ ᴳʳᵘᵖᵖᵉⁿᵐᶦᵗᵍˡᶦᵉᵈ ᵈᵃʳᵘ̈ᵇᵉʳ ᶦⁿᶠᵒʳᵐᶦᵉʳᵉⁿ, ʷᵉⁿⁿ ᵉʳ ᵍᵉʰᵗ~",
cmd: `${Prefijo}encender despedida`
}, {
action: "[ ✊ Deaktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ʷᶦʳᵈ ᵏᵉᶦⁿᵉ ᴬᵇˢᶜʰᶦᵉᵈˢᵃᶜᵗⁱᵒⁿ ᵘⁿᵗᵉʳⁿᵉʰᵐᵉⁿ~",
...
func: [{
action: "[ ⭐ Aktivieren ]",
desc: "~ᴶᵉᵗᶻᵗ ᵏönⁿᵉⁿ ⁿᵘʳ ᵈᶦᵉ ᴳʳᵘᵖᵖᵉⁿᵃᵈᵐᶦⁿˢ ᵈᵉⁿ ᴮᵒᵗ ᵛᵉʳʷᵉⁿᵈᵉⁿ~",
cmd: `${Prefijo}encender soloadmins`
}, {
action: "[ ✨ Deaktivieren ]",
desc: "~ᴶᵉᵗᶻᵗ ᵏönⁿᵉⁿ ᵃˡˡᵉ ᴳʳᵘᵖᵖᵉⁿᵗᵉᶦˡⁿᵉʰᵐᵉʳ ᵈᵉⁿ ᴮᵒᵗ ᵛᵉʳʷᵉⁿᵈᵉⁿ~",
...
func: [{
action: "[ 🌕 Aktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ʷᶦʳᵈ ᴱᶦⁿˢᵗᵉˡˡᵘⁿᵍᵉⁿ ᶦᵐ ᴳʳᵘᵖᵖᵉ ᵉʳᵏᵉⁿⁿᵉⁿ~",
cmd: `${Prefijo}encender deteccion`
}, {
action: "[ 🌑 Deaktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ʷᶦʳᵈ ᴱᶦⁿˢᵗᵉˡˡᵘⁿᵍᵉⁿ ᶦᵐ ᴳʳᵘᵖᵖᵉ ⁿᶦᶜʰᵗ ᵉʳᵏᵉⁿⁿᵉⁿ~",
...
func: [{
action: "[ 🗡️ Aktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ʷᶦʳᵈ ᵈᵉⁿ ᵀᵉᶦˡⁿᵉʰᵐᵉʳ ᵉⁿᵗᶠᵉʳⁿᵉⁿ, ᵈᵉʳ ᵉᶦⁿᵉⁿ ᴸᶦⁿᵏ ᶦᵐ ᴳʳᵘᵖᵖᵉ ᵛᵉʳˢᵉⁿᵈᵉᵗ~",
cmd: `${Prefijo}encender antienlaces`
}, {
action: "[ 😴 Deaktivieren ]",
desc: "~ᴱˢ ʷᵉʳᵈᵉⁿ ᵏᵉᶦⁿᵉ ᴬᵏᵗᶦᵒⁿᵉⁿ ᵘⁿᵗᵉʳⁿᵒᵐᵐᵉⁿ, ʷᵉⁿⁿ ᴸᶦⁿᵏˢ ᵛᵉʳˢᵉⁿᵈᵉᵗ ʷᵉʳᵈᵉⁿ~",
cmd: `${Prefijo}apagar antienlaces`
}]
}, {
titulo: "[ ⬇️ ANTI - ALLE ERWÄHNEN ]",
func: [{
action: "[ 🧐 Aktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ˡösᶜʰᵗ ᵀᵉⁱˡⁱᵉʰᵐᵉʳ ᵃⁿ ᴬˡˡᵉⁿ~",
cmd: `${Prefijo}encender antitagall`
}, {
action: "[ 😶 Deaktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ᵗᵘᵗ ˢᵉ ˢᵗⁱᶜᵏᵗ ᵃˡˡᵉⁿ~",
...
func: [{
action: "[ 🗣️ Aktivieren ]",
desc: "~ᴰᶦᵉˢᵉ ᶜᵒᵐᵐᵃⁿᵈᵒ ᵃᶜᵗᶦᵛᶦᵉʳᵗ ᵉⁱⁿᵉⁿ ᶜʰᵃᵗ⁻ᴮᵒᵗ ⁱⁿ ᵉⁱⁿᵉʳ ʷʰᵃᵗˢᵃᵖᵖ ᵍʳᵘᵖᵖᵉ~",
cmd: `${Prefijo}encender chatbot`
}, {
action: "[ 👤 Deaktivieren ]",
desc: "~ᴰᵉᵃᶜᵗⁱᵛᵃʳ ᶜʰᵃᵗ⁻ᴮᵒᵗ ⁱⁿ ᵈᵉʳ ᵃᵏᵗᵘᵉˡˡᵉⁿ ᵍʳᵘᵖᵖᵉ~",
cmd: `${Prefijo}apagar chatbot`
}]
}, {
titulo: "[ ⬇️ EINGESCHRÄNKTER MODUS ]",
func: [{
action: "[ 🌚 Aktiviert ]",
desc: "~ᴬᶜᵗᶦᵛᵃ ᵈᶦᵉ ˢᵗʳᵉᶰᵍᵉ, ᵘᵐ ᵀᵉⁱˡⁿᵉʰᵐᵉʳ ˢᵘᵖᵖᵉⁿᵗᵉⁿ ᵍʳᵘᵖᵖᵉⁿ ᵛᵒⁿ ᵀᵉⁱˡⁱⁿᵉⁿʰᵐᵉʳ⁴ˡᵉ ᵉⁿᵈᵉᶰ.~",
cmd: `${Prefijo}encender restringido`
}, {
action: "[ 🌝 Deaktiviert ]",
desc: "~ᴬᶜᶜᶦᵒⁿᵉˢ ᵈᵉˡᵉᵗᵉ ᵉᵘ ᵃᵈᵈ ᵖᵃʳᵗᶦᶜᶦᵖᵃⁿᵗᵉˢ ˢᵉʰʳ ʳᵉᶜᵒᵐᵉⁿᵈᵃᵇˡᵉ~",
...
func: [{
action: "[ 🗡️ Aktivieren ]",
desc: "~ᴰᵉʳ ᴮᵒᵗ ʷᶦʳᵈ ᵘʳˡˢ ᵛᵒⁿ ᵀᵉᶦˡⁿᵉʰᵐᵉʳⁿ ᵉⁿᵗᶠᵉʳⁿᵉⁿ~",
cmd: `${Prefijo}encender antiurl`
}, {
action: "[ 😴 Deaktivieren ]",
desc: "~ᴱˢ ʷᶦʳᵈ ᵏᵉᶦⁿᵉ ᴬᵏᵗᶦᵒⁿ ᵃᵘˢᵍᵉᶠᵘ̈ʰʳᵗ, ʷᵉⁿⁿ ᵘʳˡˢ ᵍᵉˢᵉⁿᵈᵉᵗ ʷᵉʳᵈᵉⁿ~",
...
func: [{
action: "[ 🛡️ Aktivieren ]",
desc: "~ᴰᶦᵉˢᵉʳ ᴮᵉᶠᵉʰˡ ᵃᵏᵗᶦᵛᶦᵉʳᵗ ᴰᵉⁿ ᴾʳᵒᵗᵉᵏᵗᶦᵒⁿ ᵍᵉᵍᵉⁿ ᵍᵉᵇᵘʳᵗˢʳᵘⁿᵈᵉ ⁺¹~",
cmd: `${Prefijo}encender antifake1`
}, {
action: "[ ⚰️ Deaktivieren ]",
desc: "~ᴰᵉᵃᵏᵗᶦᵛᶦᵉʳᵉⁿ ᵛᵒⁿ ᴬⁿᵗᶦ⁻ᶠᵃᵏᵉˢ ¹ ᶦᵐ ᴳʳᵘᵖᵖᵉ~",
...
func: [{
action: "[ 🛡️ Aktivieren ]",
desc: "~ˢᶦᵉ ʷᶦʳᵈ ᵈᶦᵉ ᵀᵒᵗᵘᶠᵘⁿᵏᵗᶦᵒⁿ ᵃⁿᵍᵉᵐᵃᶜʰᵗ, ᵍᵉᵍᵉⁿ ᶠᵃˡˢᶜʰᵉ ᵒᵈᵉʳ ᵛᶦʳᵗᵘᵃˡᵉ ᴺᵘᵐᵐᵉʳⁿ~",
cmd: `${Prefijo}encender antifake2`
}, {
action: "[ ⚰️ Deaktivieren ]",
desc: "~ᴬⁿᵗᶦ⁻ᶠᵃᵏᵉˢ ² ᶦᵐ ᴳʳᵘᵖᵖᵉ ᵃᵘˢˢᶜʰᵃˡᵗᵉⁿ~",
cmd: `${Prefijo}apagar antifake2`
}]
}, {
titulo: "[ ⬇️ ANTI - AUSLÄNDER ]",
func: [{
action: "[ 🏳️ Aktivieren ]",
desc: "~ˢᵉ ᵃᶜᵗᶦᵛᶦᵉʳᵗ ᵈᵉʳ ᴾʳᵒᵗᵉᵏᵗᶦᵒⁿ ᵍᵍᵉⁿ ⁿᵘᵐᵐᵉʳⁿ, ᵈᶦᵉ ⁿᶦᶜʰᵗ ᵈᵃˢ ᴾʳᵉᶠᶦˣ ᵈᵉˢ ᴱᶦᵍᵉⁿᵗᵘᵐˢ ʰᵃᵇᵉⁿ~\nᴰᶦᵉ ⁿᵘᵐᵐᵉʳⁿ, ᵈᶦᵉ ᵐᶦᵗ +" + LocPref + " ᵇᵉᵍᶦⁿⁿᵉⁿ, ʷᵉʳᵈᵉⁿ ⁿᶦᶜʰᵗ ᵍᵉˡᵒ̈ˢᶜʰᵗ~",
cmd: `${Prefijo}encender antiextranjeros`
}, {
action: "[ 🏴 Deaktivieren ]",
desc: "~ᴬᵘˢˢᶜʰᵃˡᵗᵉⁿ ᴬⁿᵗᶦᵃᵘˢˡᵃ̈ⁿᵈᵉʳ ᶦᵐ ᴳʳᵘᵖᵖᵉ~",
...
func: [{
action: "[ 🐸 Activar ]",
desc: "~ᴰᶦᵉˢᵉˢ ᵏᵒᵐᵃⁿᵈᵒ ᵃᵏᵗᶦᵛᶦᵉʳᵗ ᴬⁿᵗᶦ-ᶜʳᵃˢʰ ˢᶜʰᶦᵘᶻ ᶦᵐ ᵂʰᵃᵗˢᵃᵖᵖ~",
cmd: `${Prefijo}encender antitraba`
}, {
action: "[ 👾 Desactivar ]",
desc: "~ᴬⁿᵗᶦ⁻ᶜʳᵃˢʰ ᵍᵉᵈᵉᵃᵏᵗᶦᵛᶦᵉʳᵗ~",
...
Bunt: (n = '', k = "") => ["[ ! ] Fehler, WhatsApp-Link funktioniert nicht oder ist ungültig", `[ ! ] Bitte beachten Sie, dass die Mindestanzahl der Gruppenteilnehmer sein muss: *${MinimoDeUsuarios}*, damit der Bot funktioniert`],

Dmdf: (n = "", e = "", k = "", o = "", m = "", d = "") => ["*[ ! ] Ungültiger Link*\n_Bitte verwenden Sie einen MediaFire-Link_", `*Name:* ${n}\n*Größe:* ${e}\n*Verlängerung:* ${k}\n*Datum des Hochladens:* ${o}\n*Dateityp:* ${m}\n*URL:* ${d}`],

Menl: (a = "") => [`Hallo ${a}!, 👋`,
[{
info: `*[ Menü-Konverter ♻️ ]*
≡ ~ᶻᵘʳ ᵂᵉʳᵗᵉᵏᵒⁿᵛᵉʳᵗᶦᵉʳᵘⁿᵍ~
${Prefijo}menu cnv`
},
{
info: `*[ Menü-Downloads ♻️ ]*
≡ ~ᶻᵘʳ ᴰᵃᵗᵉᶦᵉⁿʰᵉʳᵘⁿᵗᵉʳˡᵃᵈᵘⁿᵍ~
${Prefijo}menu dwd`
},
{
info: `*[ Menü-Suche ♻️ ]*
...
{
info: `*[ Menü-Werkzeuge ♻️ ]*
≡ ~ᵂᵉʳᵏᶻᵉᵘᵍˡᶦˢᵗᵉ~
${Prefijo}menu hta`
},
{
info: `*[ Menü-Spiele ♻️ ]*
≡ ~ᴷᵒᵐᵐᵃⁿᵈᵒˢ ᶻᵘᵐ ˢᵃᵖᵖᵃˢᵉⁿ~
${Prefijo}menu gmr`
},
{
info: `*[ Menü-Admins ♻️ ]*
≡ ~ᶰᵘʳ ᶠᵘ̈ʳ ᴬᵈᵐᶦⁿᶦˢᵗʳᵃᵗᵒʳᵉⁿ~
${Prefijo}menu adm`
},
{
info: `*[ Menü-Besitzer ♻️ ]*
≡ ~ᶰᵘʳ ᶠᵘ̈ʳ ᵈᵉⁿ ᴱᶦᵍᵉⁿᵗᵘ̈ᵐᵉʳ ᵈᵉˢ ᴮᵒᵗ~
${Prefijo}menu own`
},
{
info: `*[ Menü-Zufällig ♻️ ]*
≡ ~ᶻᵘᶠᵃ̈ˡˡˢᵏᵒᵐᵐᵃⁿᵈᵒˢ~
${Prefijo}menu rdm`
},
{
info: `*[ Komplett-Menü ♻️ ]*
≡ ~ᵛᵉʳᶻᵉᶦᶜʰⁿᶦˢ ᵃˡˡᵉʳ ᴷᵒᵐᵐᵃⁿᵈᵒˢ~
${Prefijo}allmenu`
}]
],
...
Uwrn: (a = '') => `> Die erste Warnung wurde an Benutzer @${a} gesendet. Wenn Sie mehr als drei Warnungen sammeln, werden Sie aus der Gruppe entfernt.`,
