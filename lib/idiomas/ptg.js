...
Anws:(n="",e="",k="",o="")=>[`*[ ! ] Nenhuma notícia recente encontrada para esse tópico.*`,`📰 *ÚLTIMA NOTÍCIA ÙwÚ!* 📰\n\n📌 *Título:* ${n}\n🕒 *Publicado:* ${e}\n🏷️ *Categorias:* ${k}\n\n🔗 *Ler completo:* ${o}`,"*[ ✓ ] Notícias anime paradas para este chat.*","*[ ✓ ] Notícias anime ativadas. Você receberá uma notícia aleatória do dia a cada 3 horas neste chat.*","*[ ! ] Por favor, insira um dia válido (1-31).*",`*[ ! ] Não encontrei notícias para o dia ${n}${e}.*`],
