...
Jtop:(n='',k='')=>[`*[ ! ] Indique uma quantidade para gerar o top*\n_Exemplo de uso_ :\n\n${Prefijo+n} 5 Seguidores de la grasa :v`,`*\`${n}\`*\n\n`,`_${n}.º @${k}_\n`,`\n> ${NombreDelBot}`],

Jprj:(n="",e="",k="",o="",s="")=>[`\n❥ [ PAR FORMAADO ] :\n\n┏─━─━─━∞◆∞━─━─━─┓\n${e} • ${k}\n❤\n️${o} • ${s} \n┗─━─━─━∞◆∞━─━─━─┓`,`*[ ! ] Você já tem um par atualmente*\n_Você poderá formar um novo em:_ ${n} min`,"*[ ! ] Essa pessoa já tem um par, escolha alguém livre*","*[ ! ] Não há ninguém livre no grupo para emparelhar neste momento*"],

Pptv:(n="",e="",k="",o="",s=0,m=0,i="")=>[`*🪨📄✂️ Desafio enviado para @${n}*\n_Ambos devem me enviar seu combo em privado (3 a 5 movimentos, ex: pedra-papel-tesoura)_`,"*[ ! ] Você não tem um desafio de PPT ativo no momento*","*[ ! ] Combo inválido!*\n_Use entre 3 e 5 movimentos separados por hífen: pedra-papel-tesoura_","*[ ! ] Você já enviou seu combo, espere seu oponente*",`*🪨📄✂️ Combos completos!*\n> ${e}\n> ${o}\n> Placar: ${s} - ${m}\n${i ? `🏆 Vencedor: @${i}` : "Empate, ninguém ganha desta vez"}`],

Jqun:(_='')=>[`*[ ! ] Invente um assunto*\n_Exemplo:_\n\n${Prefijo+_} es gay :v?\n`,`\n👉 ${_}\n`],

Fyhc:(m=0,d="",z="")=>[`*[ ! ] Você já procurou o chapéu agora, tente novamente em:* ${m} min`,`*🎩 Encontre o chapéu escondido!*\n\n${m}\n\n_Envie seus movimentos, ex:_ /fyh 🔼🔽◀️▶️\n_Máx 8 movimentos por turno. Cuidado com buracos invisíveis..._`,"*[ ! ] Envie pelo menos uma seta direcional: 🔼 🔽 ◀️ ▶️*",`*🕳️ Você caiu em um buraco após ${m} movimento(s)!*\n\n${d}\n\n_Jogo terminado._`,`*🎩 Você encontrou o chapéu em ${m} movimento(s)!*\n\n${d}\n\n> Recompensa: +${z} limites`,`${["🔥 Você está se aproximando do chapéu...","❄️ Você está se afastando do chapéu...","➖ Você continua à mesma distância..."][m]}\n${d}\n\n_Ainda não encontrou, envie mais setas!_`],

Jtgs:(n='',e='',k='',o='')=>[`*Jogador : ${n}*\n*[ Parabéns, você ganhou!!! ]* 🥳🎉\n\n*🎰=====🎉======🎰*\n*┃ ┌────────┐ ┃*\n*┃  | ${e}*\n*┃ ├────────┤ ┃*\n*┃  | ${k} <==*\n*┃ ├────────┤ ┃*\n*┃  | ${o}*\n*┃ └────────┘ ┃*\n*🎰=====🎉======🎰*\n\n*Todos os seus limites foram redefinidos*`,`Jogador : ${n}\n\n🎰=====🪀======🎰\n┃ ┌────────┐ ┃\n┃  | ${e}\n┃ ├────────┤ ┃\n┃  | ${k}\n┃ ├────────┤ ┃\n┃  | ${o}\n┃ └────────┘ ┃\n🎰=====🪀======🎰`],

Jtgy:(m="",d="",z=true)=>[z?`*🏳‍🌈 | Teste gay*\n@${m} sua porcentagem gay é ${d}`:`*🏳‍🌈 | Teste gay*\n@${m} é ${d}`,`@${m} é ${d} gay`,"*[ ! ] Limite gay excedido [ ! ]*"],

Jttt:(n='',k='')=>[`\`[ JOGO DA VELHA ]\`\n      \n*Para criar uma sala, exemplo:*\n\n> Você pode desafiar outro jogador\n${Prefijo+n} random\n\n-\n*Para jogar contra o bot:*\n\n> Modo 1\n${Prefijo+n} bot\n\n> Modo 2\n${Prefijo+n} bot troll\n\n-\n*NOTA:*\n_Quando você estiver em uma partida ativa, use os seguintes comandos para fazer um movimento no tabuleiro de 1 a 9, Exemplo:_\n\n${Prefijo+n} 4\n`,`*Você está me desafiando!*\n\n> Você começa primeiro.\n\n${n}\n`,"Você já está jogando contra o bot. Finalize o jogo antes de entrar em uma nova sala.",`Você já está na sala "${n}". Finalize o jogo antes de entrar em outra.`,`A sala "${n}" foi removida por inatividade.`,`Sala "${n}" criada. Aguardando outro jogador que use o mesmo nome de sala para entrar...`,`Você entrou na sala "${n}". O jogo começa agora.\n${k}`,"Movimento inválido. Escolha uma posição livre entre 1 e 9.",`${n}\n\n> Vez de ${k}`,`${n}\n\n> Sua vez`],

Topl:(n="",e=0,k="",o="",s=0,_=0)=>[`*[ ! ] Ninguém jogou "${n}" ainda neste grupo*`,"*[ ! ] Ninguém jogou ainda neste grupo*",`*🏆 Tierlist — ${n}*`,"*🏆 Tierlist geral*",`${e}. @${k} — ${s} vitórias (${_} jogos)`,`${e}. @${k} — ${o} | ${s} limites ganhos | ${_} partidas`,`*🎉 Você subiu de nível!*\n_Novo cargo:_ ${o}`,`*[ ! ] Você ainda não subiu de nível*\n_Cargo atual:_ ${o}\n_Você precisa de ${s} partidas jogadas para o próximo cargo_`,`*👑 Você já tem o cargo máximo:* ${o}`,`*👤 Perfil gamer de* @${k}\n> Cargo: ${o} (Nível ${e})\n> Limites ganhos em jogos: ${s}\n> Partidas jogadas: ${_}`,`> Teste gay: ${n}`,`> Melhor caracol: ${e} dia(s) (profundidade ${s}m)`,`> Par atual: @${k} (livre em ${_} min)`,"> Par atual: nenhum",`> Último "top" em que apareceu: ${n}`,null,`> ${k}: ${s} vitórias / ${_} jogos`,"> Ainda não jogou nenhum minijogo"],
