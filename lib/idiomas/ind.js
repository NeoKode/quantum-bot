...
RpgE: (n='', e='', k='', o='', m='', d='', z='') => [`*[ ! ] Kamu telah melakukan eksplorasi baru-baru ini, harap tunggu*\n🕐 ${n}...*\n`, `🪨 ${n ? '*Tidak menemukan sumber daya saat ini u.u*' : '*Kamu menemukan:*'}\n${e ? `\n🛢️ Gas: ${e}` : ''} ${k ? `\n⚒️  Wolframio: ${k}` : ''} ${o ? `\n⚒️  Oro: ${o}` : ''} ${m ? `\n⚒️  Hierro: ${m}` : ''} ${d ? `\n⚒️  Aluminio: ${d}` : ''} ${z ? `\n⚒️  Silicio: ${z}` : ''}\n`, "🏜️ *Tidak menemukan apa-apa saat ini*\n\n", `\n*🏳️ Kamu menemukan peradaban baru:* ${n}!, aliansi dibuat ${e}, sekarang pasukanmu terdiri dari ${k} unit.`, "\n🏴 Sampai saat ini, belum ada laporan penemuan kehidupan asing di planet ini."],
