...
Jtop:(n='',k='')=>[`*[ ! ] Tentukan jumlah untuk menghasilkan top*\n_Contoh penggunaan_ :\n\n${Prefijo+n} 5 Seguidores de la grasa :v`,`*\`${n}\`*\n\n`,`_${n}.º @${k}_\n`,`\n> ${NombreDelBot}`],

Jprj:(n="",e="",k="",o="",s="")=>[`\n❥ [ PASANGAN TERBENTUK ] :\n\n┏─━─━─━∞◆∞━─━─━─┓\n${e} • ${k}\n❤\n️${o} • ${s} \n┗─━─━─━∞◆∞━─━─━─┓`,`*[ ! ] Kamu sudah punya pasangan saat ini*\n_Kamu dapat membentuk yang baru dalam:_ ${n} min`,"*[ ! ] Orang itu sudah punya pasangan, pilih yang bebas*","*[ ! ] Tidak ada yang bebas di grup untuk dipasangkan saat ini*"],

Pptv:(n="",e="",k="",o="",s=0,m=0,i="")=>[`*🪨📄✂️ Tantangan dikirim ke @${n}*\n_Keduanya harus kirim kombo saya via privat (3 sampai 5 gerakan, misal: batu-kertas-gunting)_`,"*[ ! ] Kamu tidak punya tantangan PPT aktif saat ini*","*[ ! ] Kombo tidak valid!*\n_Gunakan 3 sampai 5 gerakan dipisah tanda hubung: batu-kertas-gunting_","*[ ! ] Kamu sudah kirim kombo, tunggu lawanmu*",`*🪨📄✂️ Kombo lengkap!*\n> ${e}\n> ${o}\n> Skor: ${s} - ${m}\n${i ? `🏆 Pemenang: @${i}` : "Seri, tidak ada yang menang kali ini"}`],

Jqun:(_='')=>[`*[ ! ] Buat sebuah topik*\n_Contoh:_\n\n${Prefijo+_} es gay :v?\n`,`\n👉 ${_}\n`],

Fyhc:(m=0,d="",z="")=>[`*[ ! ] Kamu baru saja cari topi, coba lagi dalam:* ${m} menit`,`*🎩 Temukan topi tersembunyi!*\n\n${m}\n\n_Kirim gerakanmu, misal:_ /fyh 🔼🔽◀️▶️\n_Maks 8 gerakan per giliran. Hati-hati lubang tak terlihat..._`,"*[ ! ] Kirim setidaknya satu panah arah: 🔼 🔽 ◀️ ▶️*",`*🕳️ Kamu jatuh ke lubang setelah ${m} gerakan!*\n\n${d}\n\n_Permainan selesai._`,`*🎩 Kamu menemukan topi dalam ${m} gerakan!*\n\n${d}\n\n> Hadiah: +${z} batas`,`${["🔥 Kamu mendekati topi...","❄️ Kamu menjauh dari topi...","➖ Kamu masih di jarak yang sama..."][m]}\n${d}\n\n_Masih belum ketemu, kirim lebih banyak panah!_`],

Jtgs:(n='',e='',k='',o='')=>[`*Pemain : ${n}*\n*[ Selamat, kamu menang!!! ]* 🥳🎉\n\n*🎰=====🎉======🎰*\n*┃ ┌────────┐ ┃*\n*┃  | ${e}*\n*┃ ├────────┤ ┃*\n*┃  | ${k} <==*\n*┃ ├────────┤ ┃*\n*┃  | ${o}*\n*┃ └────────┘ ┃*\n*🎰=====🎉======🎰*\n\n*Semua batasmu telah direset*`,`Pemain : ${n}\n\n🎰=====🪀======🎰\n┃ ┌────────┐ ┃\n┃  | ${e}\n┃ ├────────┤ ┃\n┃  | ${k}\n┃ ├────────┤ ┃\n┃  | ${o}\n┃ └────────┘ ┃\n🎰=====🪀======🎰`],

Jtgy:(m="",d="",z=true)=>[z?`*🏳‍🌈 | Tes gay*\n@${m} persentase gay kamu adalah ${d}`:`*🏳‍🌈 | Tes gay*\n@${m} adalah ${d}`,`@${m} adalah ${d} gay`,"*[ ! ] Batas gay terlampaui [ ! ]*"],

Jttt:(n='',k='')=>[`\`[ TIC-TAC-TOE ]\`\n      \n*Untuk membuat ruang, contoh:*\n\n> Kamu bisa menantang pemain lain\n${Prefijo+n} random\n\n-\n*Untuk main melawan bot:*\n\n> Mode 1\n${Prefijo+n} bot\n\n> Mode 2\n${Prefijo+n} bot troll\n\n-\n*CATATAN:*\n_Saat kamu dalam permainan aktif, gunakan perintah berikut untuk melakukan gerakan di papan dari 1 sampai 9, Contoh:_\n\n${Prefijo+n} 4\n`,`*Kamu menantangku!*\n\n> Kamu mulai duluan.\n\n${n}\n`,"Kamu sudah bermain melawan bot. Selesaikan permainan sebelum bergabung ke ruang baru.",`Kamu sudah berada di ruang "${n}". Selesaikan permainan sebelum bergabung ke yang lain.`,`Ruang "${n}" telah dihapus karena tidak aktif.`,`Ruang "${n}" dibuat. Menunggu pemain lain yang menggunakan nama ruang yang sama untuk bergabung...`,`Kamu telah bergabung ke ruang "${n}". Permainan dimulai sekarang.\n${k}`,"Gerakan tidak valid. Pilih posisi kosong antara 1 dan 9.",`${n}\n\n> Giliran ${k}`,`${n}\n\n> Giliranmu`],

Topl:(n="",e=0,k="",o="",s=0,_=0)=>[`*[ ! ] Belum ada yang main "${n}" di grup ini*`,"*[ ! ] Belum ada yang main di grup ini*",`*🏆 Tierlist — ${n}*`,"*🏆 Tierlist umum*",`${e}. @${k} — ${s} menang (${_} permainan)`,`${e}. @${k} — ${o} | ${s} batas dimenangkan | ${_} pertandingan`,`*🎉 Kamu naik level!*\n_Role baru:_ ${o}`,`*[ ! ] Kamu belum naik level*\n_Role saat ini:_ ${o}\n_Kamu butuh ${s} pertandingan lagi untuk role berikutnya_`,`*👑 Kamu sudah punya role maksimal:* ${o}`,`*👤 Profil gamer dari* @${k}\n> Role: ${o} (Level ${e})\n> Batas dimenangkan di game: ${s}\n> Pertandingan dimainkan: ${_}`,`> Tes gay: ${n}`,`> Siput terbaik: ${e} hari (kedalaman ${s}m)`,`> Pasangan saat ini: @${k} (bebas dalam ${_} menit)`,"> Pasangan saat ini: tidak ada",`> "Top" terakhir yang dimasuki: ${n}`,null,`> ${k}: ${s} menang / ${_} permainan`,"> Belum memainkan mini game apapun"],
