...
Anws:(n="",e="",k="",o="")=>[`*[ ! ] Tidak ada berita terbaru untuk topik itu.*`,`📰 *BERITA TERBARU ÙwÚ!* 📰\n\n📌 *Judul:* ${n}\n🕒 *Dipublikasikan:* ${e}\n🏷️ *Kategori:* ${k}\n\n🔗 *Baca lengkap:* ${o}`,"*[ ✓ ] Berita anime dihentikan untuk chat ini.*","*[ ✓ ] Berita anime diaktifkan. Anda akan menerima berita acak hari ini setiap 3 jam di chat ini.*","*[ ! ] Silakan masukkan hari yang valid (1-31).*",`*[ ! ] Saya tidak menemukan berita untuk hari ${n}${e}.*`],
