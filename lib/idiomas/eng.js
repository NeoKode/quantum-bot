...
Bunt: (n = '', k = "") => ["And the WhatsApp link?", "[ ! ] Error, The link does not work or is invalid", `[ ! ] Keep in mind that the minimum number of group participants must be: *${MinimoDeUsuarios}*, for the bot to work`],
