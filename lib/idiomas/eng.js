...
Jtop:(n='',k='')=>[`*[ ! ] Specify a number to generate the top*\n_Usage example_ :\n\n${Prefijo+n} 5 Seguidores de la grasa :v`,`*\`${n}\`*\n\n`,`_${n}.º @${k}_\n`,`\n> ${NombreDelBot}`],

Jprj:(n="",e="",k="",o="",s="")=>[`\n❥ [ PAIR FORMED ] :\n\n┏─━─━─━∞◆∞━─━─━─┓\n${e} • ${k}\n❤\n️${o} • ${s} \n┗─━─━─━∞◆∞━─━─━─┓`,`*[ ! ] You already have a partner currently*\n_You can form a new one in:_ ${n} min`,"*[ ! ] That person already has a partner, choose someone free*","*[ ! ] There is no one free in the group to pair at this moment*"],

Pptv:(n="",e="",k="",o="",s=0,m=0,i="")=>[`*🪨📄✂️ Challenge sent to @${n}*\n_Both must send me their combo privately (3 to 5 moves, e.g.: rock-paper-scissors)_`,"*[ ! ] You don't have an active PPT challenge right now*","*[ ! ] Invalid combo!*\n_Use 3 to 5 moves separated by hyphens: rock-paper-scissors_","*[ ! ] You already sent your combo, wait for your opponent*",`*🪨📄✂️ Combos complete!*\n> ${e}\n> ${o}\n> Score: ${s} - ${m}\n${i ? `🏆 Winner: @${i}` : "Draw, nobody wins this time"}`],

Jqun:(_='')=>[`*[ ! ] Make up a topic*\n_Example:_\n\n${Prefijo+_} es gay :v?\n`,`\n👉 ${_}\n`],

Fyhc:(m=0,d="",z="")=>[`*[ ! ] You just searched for the hat, try again in:* ${m} min`,`*🎩 Find the hidden hat!*\n\n${m}\n\n_Send your moves, e.g.:_ /fyh 🔼🔽◀️▶️\n_Max 8 moves per turn. Beware of invisible holes..._`,"*[ ! ] Send at least one direction arrow: 🔼 🔽 ◀️ ▶️*",`*🕳️ You fell into a hole after ${m} move(s)!*\n\n${d}\n\n_Game over._`,`*🎩 You found the hat in ${m} move(s)!*\n\n${d}\n\n> Reward: +${z} limits`,`${["🔥 You're getting closer to the hat...","❄️ You're moving away from the hat...","➖ You're still at the same distance..."][m]}\n${d}\n\n_Still not found, send more arrows!_`],

Jtgs:(n='',e='',k='',o='')=>[`*Player : ${n}*\n*[ Congratulations, you won!!! ]* 🥳🎉\n\n*🎰=====🎉======🎰*\n*┃ ┌────────┐ ┃*\n*┃  | ${e}*\n*┃ ├────────┤ ┃*\n*┃  | ${k} <==*\n*┃ ├────────┤ ┃*\n*┃  | ${o}*\n*┃ └────────┘ ┃*\n*🎰=====🎉======🎰*\n\n*All your limits have been reset*`,`Player : ${n}\n\n🎰=====🪀======🎰\n┃ ┌────────┐ ┃\n┃  | ${e}\n┃ ├────────┤ ┃\n┃  | ${k}\n┃ ├────────┤ ┃\n┃  | ${o}\n┃ └────────┘ ┃\n🎰=====🪀======🎰`],

Jtgy:(m="",d="",z=true)=>[z?`*🏳‍🌈 | Gay test*\n@${m} your gay percentage is ${d}`:`*🏳‍🌈 | Gay test*\n@${m} is ${d}`,`@${m} is ${d} gay`,"*[ ! ] Gay limit exceeded [ ! ]*"],

Jttt:(n='',k='')=>[`\`[ TIC-TAC-TOE ]\`\n      \n*To create a room, example:*\n\n> You can challenge another player\n${Prefijo+n} random\n\n-\n*To play against the bot:*\n\n> Mode 1\n${Prefijo+n} bot\n\n> Mode 2\n${Prefijo+n} bot troll\n\n-\n*NOTE:*\n_When you are in an active game use the following commands to make a move on the board from 1 to 9, Example:_\n\n${Prefijo+n} 4\n`,`*You are challenging me!*\n\n> You start first.\n\n${n}\n`,"You are already playing against the bot. Finish the game before joining a new room.",`You are already in the room "${n}". Finish the game before joining another.`,`The room "${n}" has been removed due to inactivity.`,`Room "${n}" created. Waiting for another player to join using the same room name...`,`You have joined the room "${n}". The game starts now.\n${k}`,"Invalid move. Choose a free position between 1 and 9.",`${n}\n\n> Turn of ${k}`,`${n}\n\n> Your turn`],

Topl:(n="",e=0,k="",o="",s=0,_=0)=>[`*[ ! ] No one has played "${n}" yet in this group*`,"*[ ! ] No one has played yet in this group*",`*🏆 Tierlist — ${n}*`,"*🏆 General tierlist*",`${e}. @${k} — ${s} wins (${_} games)`,`${e}. @${k} — ${o} | ${s} limits won | ${_} matches`,`*🎉 You leveled up!*\n_New role:_ ${o}`,`*[ ! ] You haven't leveled up yet*\n_Current role:_ ${o}\n_You need ${s} more games played for the next role_`,`*👑 You already have the max role:* ${o}`,`*👤 Gamer profile of* @${k}\n> Role: ${o} (Level ${e})\n> Limits won in games: ${s}\n> Games played: ${_}`,`> Gay test: ${n}`,`> Best snail: ${e} day(s) (depth ${s}m)`,`> Current partner: @${k} (free in ${_} min)`,"> Current partner: none",`> Last "top" they appeared in: ${n}`,null,`> ${k}: ${s} wins / ${_} games`,"> Hasn't played any minigame yet"],
