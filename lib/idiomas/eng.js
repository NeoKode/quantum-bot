...
AdmOpt: (n = '', k = "") => [`The ${k} was ${n ? 'turned on' : 'turned off'} for this chat`, "Here is the list of options :3", "Option:", "Description:", "Command:", [
  ...
  },
  {
    t: "[ ⬇️ ANTI-FOREIGNERS ]",
    o1: "[ 🏳️ Enable ]",
    d1: `~Protection against numbers other than the owner's prefix is enabled.
    Numbers starting with  +${LocPref}  will not be removed~`,
