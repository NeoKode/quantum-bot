...
Anws:(n="",e="",k="",o="")=>[`*[ ! ] No recent news found for that topic.*`,`📰 *LATEST NEWS ÙwÚ!* 📰\n\n📌 *Title:* ${n}\n🕒 *Published:* ${e}\n🏷️ *Categories:* ${k}\n\n🔗 *Read full:* ${o}`,"*[ ✓ ] Anime news stopped for this chat.*","*[ ✓ ] Anime news activated. You will receive a random news of the day every 3 hours in this chat.*","*[ ! ] Please enter a valid day (1-31).*",`*[ ! ] I didn't find news for day ${n}${e}.*`],
