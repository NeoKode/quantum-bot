...
RpgE: (n='', e='', k='', o='', m='', d='', z='') => [`*[ ! ] You have already performed a scan recently, please wait*\n🕐 ${n}...*\n`, `🪨 ${n ?  "*You didn't find resources for now u.u*" : "*Have you discovered:*"}\n${e ?  `\n🛢️ Gas: ${e}` : ''} ${k ?  `\n⚒️ Wolfram: ${k}` : ''} ${o ?  `\n⚒️ Gold: ${o}` : ''} ${m ?  `\n⚒️ Iron: ${m}` : ''} ${d ?  `\n⚒️ Aluminum: ${d}` : ''} ${z ?  `\n⚒️ Silicon: ${z}` : ''}\n`, "🗑️ *Nothing found so far*\n\n", `*🏳️ You have found a new civilization:* ${n}!, alliances made ${e}, now your horde is made up of ${k} units.`, "🏴 So far, no sightings of alien life have been recorded on this planet."],
